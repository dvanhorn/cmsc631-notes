...
Having a ``calculus of programs'' is important to reason about
programs, but we would also like to make the calculation of answers
mechanical.  Doing so consists of establishing a strategy for a
machine to apply reduction in order to obtain an answer.  This
strategy is called the \deftech{standard reduction semantics};
it represent a canonical way in which programs are reduced.
