...
case $\Arith$).  The describing language itself (in this case it is
math, but often it is another programming language) is called the
...
meta-variable signals the set of values it ranges over.  So for example
a meta-variable $\mint$ may refer to $5$ or $17$, but never $\Succ(3)$.
