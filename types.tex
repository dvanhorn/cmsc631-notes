...
%% up facts about the program as a logic statement about what must be
%% true at any given point during the execution.
...
%% \mathit{Condition}        & \mcon  & ::= & \mvar = \msval\cdot\msval\ |\ \mvar = \msval\ |\ \mvar \neq \msval\\
