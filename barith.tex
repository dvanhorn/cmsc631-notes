...
\inferrule{\envreduce\mexp{(\breducename\; \cup\; \err\; \cup\; \prop)}{\mexp'}}
          {\envreduce{\plug\mectx\mexp}{\std\berr}{\plug\mectx{\mexp'}}}
\end{mathpar}
...
\Plus(3,\Mult(2,\Err_{\Div0})) \;\compat\berr\;
\Plus(3,\Err_{\Div0}) \;\compat\berr\;
\Err_{\Div0}
\end{mathpar}
...
\inferrule{\mectx \neq \hole }
          {\envreduce{\plug\mectx{\Err_\ell}}{\std{\berr'}}{\Err_\ell}}
\end{mathpar}
